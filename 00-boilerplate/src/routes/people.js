const createQuerySearchPeople = require("../utils/createQuerySearchPeople");
...
function createPeopleRouter(mongoClient) {
	peopleCollection = mongoClient.db("blog").collection("people");
	return routes;
}
